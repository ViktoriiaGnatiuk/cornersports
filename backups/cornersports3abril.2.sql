...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-04-2020 a las 01:29:56
...
CREATE TABLE `entrenadores` (
  ...
  `entrenamientos` int(10) DEFAULT NULL
...
INSERT INTO `entrenadores` (`id`, `nombre`, `escpecialidad`, `sueldo`, `puntuacion`, `entrenamientos`) VALUES
(1, 'Viktoriia', 'Cardio', '1500', 4, NULL);
...
INSERT INTO `entrenamientos_disponibles` (`id`, `nombre`, `dias`, `precio`, `entrenador`, `dificultad`) VALUES
(1, 'Cardio en casa Coronavirus version', 30, 35, 1, 'media');
