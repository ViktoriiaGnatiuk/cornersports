...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2020 a las 12:43:15
...
INSERT INTO `ofertas` (`id`, `nombre`, `tipo`, `imagen`, `descuento`) VALUES
(5, 'Mancuernas Barbaria 17.5kg', 'maquina', 'productos/mancuernas1.jpg', 20),
(6, 'Eliptica Bodytone DEE15', 'maquina', 'productos/eliptica1.jpg', 20),
(7, 'Guantes de boxeo Everlast M', 'deportes', 'productos/guantes_boxeo1.jpg', 20);
...
(2, 'Máquina remo', 'maquina', 'productos/remo.png', 'Máquina remo', 16.95, 5.6),
...
(8, 'Esquís', 'material', 'productos/esquies.jpg', 'Esquís', 300, 100),
(9, 'Patines', 'material', 'productos/patines.jpg', 'Patines', 50, 15),
(10, 'Bates', 'material', 'productos/bate.jpg', 'Bates', 60, 10);
...
INSERT INTO `usuarios` (`username`, `password`, `nombre`, `apellidos`, `email`, `provincia`, `localidad`, `calle`, `codPostal`, `portal`, `perfil`, `entrenamiento_activo`, `maquina_activa`, `material`) VALUES
('admin', '$2y$10$MTwLq7RS.AAPoBeHx0tH7ufP406mN1aVe7GwJgG8xPnxS3aoJrjrK', 'admin', 'admin', 'adasd@', 'sadas', 'dasd', 'dsds', '', 'dasda', 'admin', 19, 1, 8),
('kotito', '$2y$10$3sO.UL8euG9Qj7oShrstNOlC105UIkkZd8iXyKpGsKoPdAxzXYRNa', 'kotito', 'bg', 'kotito@gato.es', 'madrid', 'alcala', 'gatito 25', '20554', '5', 'usuario', NULL, 0, NULL),
('kotito2', '$2y$10$CAsAgCeOZl9rHQQ/43n8M.Qwwi8AMMmb28xQ6wFBdDTX6PCx6qOL.', 'kotito', 'bg', 'kotito@gato.es', 'madrid', 'alcala', 'gatito 25', '20554', '5', 'usuario', NULL, 0, NULL),
('vicky', '$2y$10$IqkfN1PkF9cdhix7UJd2.Oz8yT3NRTTs/nutHxW3tF.a574cLpOjq', 'Viktoriia', 'Gnatiuk', 'adas#¡@adasa.com', 'adas', 'adasa', 'daasdad', 'dasda', 'dada', 'usuario', NULL, 0, NULL);
